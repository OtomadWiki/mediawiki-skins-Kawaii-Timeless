...
/*水波纹*/
$("#mw-site-navigation li, #mw-related-navigation li, #personal li, .mini-block-container li, .tools-inline li, .oo-ui-buttonElement-button, .suggestions .suggestions-special, .suggestions a.mw-searchSuggest-link, .mw-editsection a, #p-variants-desktop .dropdown li, .flowthread-btn, .header-links-a, .oo-ui-dropdownWidget, .oo-ui-menuOptionWidget, .mw-htmlform-field-UploadSourceField .mw-input, #profile-toggle-button, .mw-specialpages-list li, .comment-reply, .comment-like, .comment-report, .comment-delete").addClass("mdui-ripple");
