...
class TimelessTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		$html .= Html::rawElement( 'div' , [ 'id' => 'siteBanner', 'class' => 'siteBanner' ],
			Html::rawElement( 'div' , [ 'id' => 'topHeadingImage', 'class' => 'topHeadingImage', 'style' => 'background-image: url(/kawaii/banner/BG-2023011906.png);' ]).
			//, 'style' => 'background-image: url(/kawaii/banner/BG-20220705.png);'
			Html::rawElement( 'div' , [ 'id' => 'bannerItems', 'class' => 'bannerItems' ],
				Html::rawElement( 'a', [ 'href' => '/', 'name' => 'OtomadWiki' ],
					...
					Html::rawElement( 'img' , [ 'id' => 'topHeadingLogo', 'class' => 'topHeadingLogo', 'src' => '/kawaii/BlackLogo.png', 'title' => 'OtomadWiki' ]),
			).
			Html::rawElement( 'a', [ 'title' => '新春快乐' ],
					Html::rawElement( 'img' , [ 'id' => 'bannerContent', 'class' => 'bannerContent', 'src' => '/kawaii/banner/SpringFestival/SpringTextSerif.png', 'title' => '新春快乐' ]),
			).
